...
export const Icons = [
  {img: localimages.dislikeIcon, title: '50'},
  {img: localimages.likeIcon, title: '50'},
  // localimages.dislikeIcon,
  //   localimages.shareIcon,
  //   localimages.favoriteIcon,
  //   localimages.moneyIcon,

  {img: localimages.shareIcon, title: 'share'},
  {img: localimages.favoriteIcon, title: 'Favorite'},
  {img: localimages.moneyIcon, title: 'Donate'},
];
